...
class AutoV2 {
  ...
  // Baujahr variiert häufig zwischen einem Auto und einem anderen,
  // daher ist es nicht sinnvoll, es als Konstante zu deklarieren
  ...
  void transportieren() {
    print('AutoV2 5 Personen werden transportiert');
  }
